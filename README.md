...
TC-ACApp是一个基于Django + WebSocket的多人实时对战游戏。该项目展示了全栈开发能力，包含完整的用户系统、实时通信、游戏匹配、技能战斗等核心功能。
...
##### 🎮 基础操作
- **移动角色**: 鼠标左键点击目标位置进行移动
- **视角跟随**: 角色会自动跟随，保持游戏画面中心
- **游戏聊天**: 按回车键打开聊天窗口，与其他玩家交流
...
- 技能效果：瞬间传送，可穿越障碍物
- 冷却时间：5秒
- 使用技巧：追击敌人、躲避攻击、快速调整位置

##### 🎯 战斗策略
1. **技能选择**: 根据战况按Q或F选择合适技能
2. **技能释放**: 选中技能后，右键点击目标位置释放
3. **走位技巧**: 合理运用移动和闪烁躲避敌人攻击
4. **团队配合**: 与队友沟通，协同作战
5. **血量管理**: 注意自身血量，适时撤退恢复
